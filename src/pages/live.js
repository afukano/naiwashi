...
const SecondPage = () => (
  <Layout>
    ...
    <p>
      ...
      <a href="https://www.youtube.com/channel/UC2Kb6k-aGIaKxlNPkrdcoHA" target="_blank">Youtubeチャンネル</a>はこちら<br/>
      【参考ページ】<Link to="https://weekly.ascii.jp/elem/000/001/634/1634383/" target="_blank">YouTube「チャンネル登録」「通知設定」をする意味とメリット</Link><br/>
      <br/>
      ...
      <blockquote class="twitter-tweet">
        ...
        &mdash; ござ 🎹 (@gprza) 
        <a href="https://twitter.com/gprza/status/1348597702674714625?ref_src=twsrc%5Etfw" target="_blank">
          January 11, 2021
        </a>
      </blockquote>
      遅くともライブ配信の数時間前には、ライブ配信をする旨ツイートしてくれる。<br/>
      <a href="https://twitter.com/gprza" target="_blank">Twitter</a>はこちら<br/>
    </p>
    <h3>ないわし？</h3>
    <p>
    ...
    <p>
      ...
      【参考ページ】<Link to="https://news.mynavi.jp/article/20201130-1350177/" target="_blank">YouTube メンバーシップとは? 支払い方法や退会方法を解説</Link><br/>
      ただし、iPhoneの場合は手順がやや複雑なため注意が必要。<br/>
      【参考ページ】<Link to="https://did2memo.net/2019/09/02/youtube-channel-member-iphone/" target="_blank">YouTube メンバーシップとは? 【YouTube】iPhoneからチャンネルの「メンバー登録」をする手順（メンバーになるボタンが表示されない問題の対策）</Link><br/>
    </p>
    ...
    <p>
      ...
      <small>Created by <Link to="https://twitter.com/zan_ryur_goza" target="_blank">ざん</Link></small><br/>
    </p>
  </Layout>
)
